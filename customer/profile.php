                ...
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-primary" aria-labelledby="navbarDarkDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="logout.php" onclick="return confirm('Are You Sure?')">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <section class="container mb-5" style="background-color: white;">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4 text-center">
                ...
                <img class="rounded-circle border border-primary mb-3" width="200px" height="200px" src="../image/profile/<?= $_SESSION["picture"] ?>" alt="" id="" name="">
            ...
            <div class="mb-4">
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Name" value="<?= $_SESSION["nama"] ?>">
            </div>
            <div class="mb-4">
